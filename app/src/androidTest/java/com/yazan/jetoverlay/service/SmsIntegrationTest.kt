...
class SmsIntegrationTest : BaseAndroidTest() {
    ...
    // Note: SMS permissions (RECEIVE_SMS, READ_SMS) cannot be granted via GrantPermissionRule
    // as they require special system privileges. Tests that need actual SMS functionality
    // should be run with manual permission grants or shell commands.
    ...
    @Test
    fun messageRepository_ingestsSmsMessage_correctly() {
        runBlockingTest {
    ...
    @Test
    fun messageRepository_distinguishesSmsFromNotifications() {
        runBlockingTest {
    ...
    @Test
    fun messageRepository_handlesPhoneNumberFormats() {
        runBlockingTest {
